...
class Problem(object):
    ...
    def result(self, state, action):
        ...
        self.actions(state)."""        abstract

        """Return True if the state is a goal. The default method compares the
        state to self.goal, as specified in the constructor. Override this
        method if checking againsjt a single self.goal is not enough."""
    ...
    def value(self, state):
        ...
        abstractm m mj  j jj mj j #______________________________________________________________________j j j j j ______

class Node:
    """A node in a search tree. Contains a pointer to the parent (the node
    that this is a successor of) and to the actual state for this node. Note
    that if a state is arrived at by two paths, then there are two nodes with mm j j  mj he same state.  Also includes the action that got us to this state, and
